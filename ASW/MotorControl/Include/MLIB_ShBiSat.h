...
static inline tFrac32 ShBiSat_F32_C(register tFrac32 f32In,register tS16 s16In)
/*
...
static inline tFrac16 ShBiSat_F16_C(register tFrac16 f16In,register tS16 s16In)
/*
* @violates @ref MLIB_ShBiSat_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
...
@brief        This function shifts the first argument to left or right by number defined
              by second argument and saturate if necessary.
...
@details      Based on sign of second parameter this function shifts the first
              parameter to right or left and saturate if an overflow is detected.
...
static inline tFrac32 MLIB_ShBiSat_F32(register tFrac32 f32In1,register tS16 s16In2)
/*
...
#endif /* if defined __CWCC__ || defined __MWERKS__ */
/** @remarks Implements DMLIB00155, DMLIB00149, DMLIB00153 */
static inline tFrac16 MLIB_ShBiSat_F16(register tFrac16 f16In1,register tS16 s16In2)
/*
* @violates @ref MLIB_ShBiSat_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in
* header file.
*/
