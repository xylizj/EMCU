...
static inline tFrac32 MLIB_DivSat_F32(register tFrac32 f32In1,register tFrac32 f32In2)
/*
...
*/
{
  ...
  */
  ...
  if (f32In2 == (tFrac32)0){
    f32Out = (f32In1 > (tFrac32)0) ? INT32TOF32(INT32_MAX) : INT32TOF32(INT32_MIN);
  }else{
    /*
    ...
    * signed underlying type (&).
    */
    f32Out = (MLIB_AbsSat_F32(f32In1) >= MLIB_AbsSat_F32(f32In2)) ? ((((INT32_MIN & f32In1)^(INT32_MIN & f32In2)) == INT32_MIN)? INT32TOF32(INT32_MIN) : INT32TOF32(INT32_MAX)) : MLIB_Div_F32(f32In1, f32In2);
  }
...
static inline tFrac16 MLIB_DivSat_F16(register tFrac16 f16In1,register tFrac16 f16In2)
/*
* @violates @ref MLIB_DivSat_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in
* header file.
*/
{
  ...
  */
  ...
  if (f16In2 == (tFrac16)0){
    f16Out = (f16In1 > (tFrac16)0) ? INT16TOF16(INT16_MAX) : INT16TOF16(INT16_MIN);
  }else{
    /*
    * @violates @ref MLIB_DivSat_h_REF_6 MISRA 2004 Required Rule 12.7, Bitwise operator applied to
    * signed underlying type (^).
    ...
    * signed underlying type (~).
    */
    f16Out = (MLIB_AbsSat_F16(f16In1) >= MLIB_AbsSat_F16(f16In2)) ? ((((INT16_MIN & f16In1)^(INT16_MIN & f16In2)) == INT16_MIN) ? INT16TOF16(INT16_MIN) : INT16TOF16(INT16_MAX)) : MLIB_Div_F16(f16In1, f16In2);
  }
