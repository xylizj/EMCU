...
/** @remarks Implements DMLIB00261, DMLIB00257, DMLIB00259, DMLIB00256 */
static inline tFrac32 MLIB_Convert_F32F16(register tFrac16 f16In1,register tFrac16 f16In2)
/*
...
@details      This inline function returns converted input value. The input value is considered as single precision
              floating point data type and output value is considered as 32-bit fractional data type. The second value
              represents the scale factor and is considered as single precision floating point data type. The output value
              ...
              \image rtf convertEq1_f32flt.math "MLIB_Convert_Eq1"
...
#pragma always_inline on
#endif /* if defined __CWCC__ || defined __MWERKS__ */
/** @remarks Implements DMLIB00261, DMLIB00254, DMLIB00255, DMLIB00257, DMLIB00259 */
static inline tFrac32 MLIB_Convert_F32FLT(register tFloat fltIn1,register tFloat fltIn2)
/*
* @violates @ref MLIB_Convert_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in
* header file.
*/
...
#pragma always_inline on
#endif /* if defined __CWCC__ || defined __MWERKS__ */
/** @remarks Implements DMLIB00261, DMLIB00256, DMLIB00257, DMLIB00259 */
static inline tFrac16 MLIB_Convert_F16F32(register tFrac32 f32In1,register tFrac32 f32In2)
/*
* @violates @ref MLIB_Convert_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in
* header file.
*/
...
@details      This inline function returns converted input value. The input value is considered as single precision
              floating point data type and output value is considered as 16-bit fractional data type. The second value
              represents the scale factor and is considered as single precision floating point data type. The output value
              represents the values in unity model. The output saturation is implemented in this function, thus in case
              the input value is outside the (-1, 1) interval, the output value is limited to the boundary value.
              ...
              \image rtf convertEq1_f16flt.math "MLIB_Convert_Eq1"
...
#pragma always_inline on
#endif /* if defined __CWCC__ || defined __MWERKS__ */
/** @remarks Implements DMLIB00261, DMLIB00254, DMLIB00255, DMLIB00256, DMLIB00259 */
static inline tFrac16 MLIB_Convert_F16FLT(register tFloat fltIn1,register tFloat fltIn2)
/*
* @violates @ref MLIB_Convert_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in
* header file.
*/
...
@brief        This function converts the input value to different representation.
...
@details      This inline function returns converted input value. The input value is considered as 16-bit fractional
              ...
              represents the values in unity model. The second value represents the scale factor and is considered as 16-bit
              fractional data type. The sign of the second value represents the scale mechanism. In case the second value
              is positive the first input value is multiplied with the second one and converted to the output format.
              In case the second value is negative, the first input value is divided by absolute value of second input
              value and converted to the output format. The output saturation is not implemented in this function.

              \par

              The output of the function is defined by the following simple equation:
              \anchor eq1_Convert_FLTF16
              \image rtf convertEq1_fltf16.math "MLIB_Convert_Eq1"
...
#endif /* if defined __CWCC__ || defined __MWERKS__ */
/** @remarks Implements DMLIB00261, DMLIB00254, DMLIB00255, DMLIB00256, DMLIB00259 */
static inline tFloat MLIB_Convert_FLTF16(register tFrac16 f16In1,register tFrac16 f16In2)
/*
* @violates @ref MLIB_Convert_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in
* header file.
*/
{
  ...
  return((f16In2>=(tFrac16)0) ? MLIB_Div_FLT((tFloat)MLIB_Mul_F32F16F16(f16In1,f16In2),(((tFloat)(INT32_MAX))+(tFloat)1))
                              ...
                              */
                              : (((f16In1>=(tFrac16)0)&&(f16In1 >= MLIB_NegSat_F16(f16In2)))?(tFloat)1
...
@details      This inline function returns converted input value. The input value is considered as 32-bit fractional
              data type and output value is considered as single precision floating point data type. The input value
              represents the values in unity model. The second value represents the scale factor and is considered as 32-bit
              fractional data type. The sign of the second value represents the scale mechanism. In case the second value
              is positive the first input value is multiplied with the second one and converted to the output format.
              In case the second value is negative, the first input value is divided by absolute value of second input
              value and converted to the output format. The output saturation is not implemented in this function.
              ...
              \image rtf convertEq1_fltf32.math "MLIB_Convert_Eq1"
...
#endif /* if defined __CWCC__ || defined __MWERKS__ */
/** @remarks Implements DMLIB00261, DMLIB00254, DMLIB00255, DMLIB00257, DMLIB00259 */
static inline tFloat MLIB_Convert_FLTF32(register tFrac32 f32In1,register tFrac32 f32In2)
/*
* @violates @ref MLIB_Convert_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in
* header file.
*/
{
  ...
  */
  return((f32In2>=(tFrac32)0) ? MLIB_Div_FLT((tFloat)(((tS64)f32In1*(tS64)f32In2)<<1),((tFloat)(((tS64)INT32_MAX) << (tU16)32)))
                              ...
                              * Bitwise operator applied to signed underlying type.
                              */
                              : (((f32In1>=(tFrac32)0)&&(f32In1 >= MLIB_NegSat_F32(f32In2)))?(tFloat)1
