...
****************************************************************************/
  ...
  *//**********************************************************************/
  ...
  typedef struct{
    ...
    tFrac32 f32UpperLimit; /*!< Upper Limit of the controller, fractional format normalized to fit into (-2\f$^{31}\f$, 2\f$^{31}\f$-1). */
    tFrac32 f32LowerLimit; /*!< Lower Limit of the controller, fractional format normalized to fit into (-2\f$^{31}\f$, 2\f$^{31}\f$-1). */
...
****************************************************************************/
  ...
  *//**********************************************************************/
  ...
  typedef struct{
    ...
    tFrac16 f16UpperLimit; /*!< Upper Limit of the controller, fractional format normalized to fit into (-2\f$^{15}\f$, 2\f$^{15}\f$-1). */
    tFrac16 f16LowerLimit; /*!< Lower Limit of the controller, fractional format normalized to fit into (-2\f$^{15}\f$, 2\f$^{15}\f$-1). */
