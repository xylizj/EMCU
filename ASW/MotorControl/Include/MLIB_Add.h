...
* Inline functions
****************************************************************************/
/* MLIB_Add_F32 implementation variant - C */
static inline tFrac32 Add_F32_C(register tFrac32 f32In1,register tFrac32 f32In2)
/*
...
/* MLIB_Add_F16 implementation variant - C */
static inline tFrac16 Add_F16_C(register tFrac16 f16In1,register tFrac16 f16In2)
/*
* @violates @ref MLIB_Add_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
...
@brief        This function returns sum of two input parameters.
...
@details      This inline function returns the sum of two input values. The input values as well as output value is considered
              as 32-bit fractional data type. The output saturation is not implemented in this function, thus in case
              the sum of input values is outside the (-1, 1) interval, the output value will overflow without any detection.

              \par

              The output of the function is defined by the following simple equation:
              \anchor eq1_Add_F32
              \image rtf addEq1_f32.math "MLIB_Add_Eq1"
...
static inline tFrac32 MLIB_Add_F32(register tFrac32 f32In1, register tFrac32 f32In2)
/*
* @violates @ref MLIB_Add_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
{
  ...
  return(Add_F32_C(f32In1,f32In2));
}
...
@details      This inline function returns the sum of two input values. The input values as well as output value is considered
              as 16-bit fractional values. The output saturation is not implemented in this function, thus in case the
              sum of input values is outside the (-1, 1) interval, the output value will overflow without any detection.

              \par

              The output of the function is defined by the following simple equation:
              \anchor eq1_Add_F16
              \image rtf addEq1_f16.math "MLIB_Add_Eq1"
...
static inline tFrac16 MLIB_Add_F16(register tFrac16 f16In1, register tFrac16 f16In2)
/*
* @violates @ref MLIB_Add_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
{
  /** @remarks Implements DMLIB00046 */
  return(Add_F16_C(f16In1,f16In2));
}
...
@details      This inline function returns the sum of two input values. The input values as well as output value is considered
              as single precision floating point data type. The output saturation is not implemented in this function,
              thus in case the sum of input values is outside the (-2\f$^{128}\f$, 2\f$^{128}\f$) interval, the output value will
              ...
              The output of the function is defined by the following simple equation:
              \anchor eq1_Add_FLT
              \image rtf addEq1_flt.math "MLIB_Add_Eq1"
...
static inline tFloat MLIB_Add_FLT(register tFloat fltIn1, register tFloat fltIn2)
/*
* @violates @ref MLIB_Add_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
