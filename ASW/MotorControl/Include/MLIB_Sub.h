...
* Inline functions
****************************************************************************/
/* MLIB_Sub_F32 implementation variant - C */
static inline tFrac32 Sub_F32_C(register tFrac32 f32In1,register tFrac32 f32In2)
/*
...
/* MLIB_Sub_F16 implementation variant - C */
static inline tFrac16 Sub_F16_C(register tFrac16 f16In1,register tFrac16 f16In2)
/*
* @violates @ref MLIB_Sub_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
...
static inline tFrac32 MLIB_Sub_F32(register tFrac32 f32In1,register tFrac32 f32In2)
/*
* @violates @ref MLIB_Sub_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
{
  ...
  return(Sub_F32_C(f32In1,f32In2));
}
...
static inline tFrac16 MLIB_Sub_F16(register tFrac16 f16In1,register tFrac16 f16In2)
/*
* @violates @ref MLIB_Sub_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
{
  /** @remarks Implements DMLIB00067 */
  return(Sub_F16_C(f16In1,f16In2));
}
...
@details      Subtraction of two single precision floating point values. The second argument is subtracted from the
              first one. The input value as well as output value is considered as single precision floating point data
              type. The output saturation is not implemented in this function, thus in case the subtraction of input
              parameters is outside the (-2\f$^{128}\f$, 2\f$^{128}\f$) interval, the output value will overflow without
              any detection.
              ...
              The output of the function is defined by the following simple equation:
              \anchor eq1_Sub_FLT
              \image rtf subEq1_flt.math "MLIB_Sub_Eq1"
...
static inline tFloat MLIB_Sub_FLT(register tFloat fltIn1,register tFloat fltIn2)
/*
* @violates @ref MLIB_Sub_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
