...
* Inline functions
****************************************************************************/
static inline tFrac32 Mac_F32_C(register tFrac32 f32In1, register tFrac32 f32In2, register tFrac32 f32In3)
/*
...
static inline tFrac32 Mac_F32F16F16_C(register tFrac32 f32In1, register tFrac16 f16In2, register tFrac16 f16In3)
/*
* @violates @ref MLIB_Mac_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
...
static inline tFrac16 Mac_F16_C(register tFrac16 f16In1, register tFrac16 f16In2, register tFrac16 f16In3)
/*
* @violates @ref MLIB_Mac_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
...
#if (SWLIBS_SUPPORT_FLT == SWLIBS_STD_ON)
static inline tFloat Mac_FLT_C(register tFloat fltIn1, register tFloat fltIn2, register tFloat fltIn3)
/*
* @violates @ref MLIB_Mac_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
...
#if defined(__ghs__)
  static inline tFloat Mac_FLT_GHS_EFPU2(register tFloat fltIn1, register tFloat fltIn2, register tFloat fltIn3)
/*
* @violates @ref MLIB_Mac_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
  {
    ...
    */
    ...
    fltReturn = fltIn1;
    #pragma ghs optasm
    asm("efsmadd %0,%1,%2" : "+r"(fltReturn): "r"(fltIn2) "r"(fltIn3));
    return((tFloat)fltReturn);
  }
#elif defined(__CWCC__) || defined(__MWERKS__)
  static inline tFloat Mac_FLT_CW_EFPU2(register tFloat fltIn1, register tFloat fltIn2, register tFloat fltIn3)
/*
* @violates @ref MLIB_Mac_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
...
* file.
*/
/*lint -sem(asm_mac_flt, pure) */
asm tFloat asm_mac_flt(tFloat fltIn1, tFloat fltIn2, tFloat fltIn3){
%reg fltIn1,fltIn2,fltIn3

  or r3,fltIn1,fltIn1
  efsmadd r3,fltIn2,fltIn3
}
static inline tFloat Mac_FLT_DIAB_EFPU2(register tFloat fltIn1, register tFloat fltIn2, register tFloat fltIn3)
/*
* @violates @ref MLIB_Mac_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
{
  return((tFloat)asm_mac_flt(fltIn1, fltIn2, fltIn3));
}
...
static inline tFrac32 MLIB_Mac_F32(register tFrac32 f32In1,register tFrac32 f32In2,register tFrac32 f32In3)
/*
* @violates @ref MLIB_Mac_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
...
static inline tFrac32 MLIB_Mac_F32F16F16(register tFrac32 f32In1,register tFrac16 f16In2,register tFrac16 f16In3)
/*
* @violates @ref MLIB_Mac_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
...
static inline tFrac16 MLIB_Mac_F16(register tFrac16 f16In1,register tFrac16 f16In2,register tFrac16 f16In3)
/*
* @violates @ref MLIB_Mac_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
...
@details      This inline function returns the multiplied second and third input value with added
              first input value. The input values as well as output value are considered as single
              precision floating point data type. Intermediate results are computed in infinite
              precision. The result is undefined in case of overflow or underflow in any
              ...
              The output of the function is defined by the following simple equation:
              \anchor eq1_Mac_FLT
              \image rtf macEq1_flt.math "MLIB_Mac_Eq1"
...
static inline tFloat MLIB_Mac_FLT(register tFloat fltIn1,register tFloat fltIn2,register tFloat fltIn3)
/*
* @violates @ref MLIB_Mac_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
{
  #if defined(__ghs__)
    /** @remarks Implements DMLIB00213 */
    return(Mac_FLT_GHS_EFPU2(fltIn1, fltIn2, fltIn3));
  #elif defined(__CWCC__) || defined(__MWERKS__)
    /** @remarks Implements DMLIB00213 */
    return(Mac_FLT_CW_EFPU2(fltIn1, fltIn2, fltIn3));
  #elif defined(__DCC__)
    /** @remarks Implements DMLIB00213 */
    return(Mac_FLT_DIAB_EFPU2(fltIn1, fltIn2, fltIn3));
  #else
    /** @remarks Implements DMLIB00213 */
