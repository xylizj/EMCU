...
static inline tFrac32 ShLSat_F32_C(register tFrac32 f32In,register tU16 u16In)
/*
...
*/
{
  ...
  */
  ...
  f32Temp = MLIB_ShR_F32(INT32TOF32(INT32_MAX),u16In);
  if(f32In > f32Temp){
    f32Out = INT32TOF32(INT32_MAX);
  }else{
    f32Temp = MLIB_ShR_F32(INT32TOF32(INT32_MIN),u16In);
    if(f32In <= f32Temp){
...
static inline tFrac16 ShLSat_F16_C(register tFrac16 f16In,register tU16 u16In)
/*
* @violates @ref MLIB_ShLSat_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
{
  ...
  */
  ...
  f16Temp = MLIB_ShR_F16(INT16TOF16(INT16_MAX),u16In);
  if(f16In>f16Temp){
    f16Out = INT16TOF16(INT16_MAX);
  }else{
    f16Temp = MLIB_ShR_F16(INT16TOF16(INT16_MIN),u16In);
    if(f16In <= f16Temp){
...
static inline tFrac32 MLIB_ShLSat_F32(register tFrac32 f32In1,register tU16 u16In2)
/*
* @violates @ref MLIB_ShLSat_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in
* header file.
*/
...
static inline tFrac16 MLIB_ShLSat_F16(register tFrac16 f16In1,register tU16 u16In2)
/*
* @violates @ref MLIB_ShLSat_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in
* header file.
*/
