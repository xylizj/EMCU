...
****************************************************************************/
  ...
  *//***********************************************************************/
  ...
  typedef struct{
    tFrac32 f32B0; /*!< B0 coefficient of an IIR1 filter, fractional format normalized to fit into (-2\f$^{31}\f$, 2\f$^{31}\f$-1). */
    tFrac32 f32B1; /*!< B1 coefficient of an IIR1 filter, fractional format normalized to fit into (-2\f$^{31}\f$, 2\f$^{31}\f$-1). */
    tFrac32 f32A1; /*!< A1 coefficient of an IIR1 filter, fractional format normalized to fit into (-2\f$^{31}\f$, 2\f$^{31}\f$-1). */
  ...
  *//***********************************************************************/
  ...
  typedef struct{
    ...
    tFrac32 f32FiltBufferX[1]; /*!< Input buffer of an IIR1 filter, fractional format normalized to fit into (-2\f$^{31}\f$, 2\f$^{31}\f$-1). */
    tFrac32 f32FiltBufferY[1]; /*!< Internal accumulator buffer, fractional format normalized to fit into (-2\f$^{31}\f$, 2\f$^{31}\f$-1). */
