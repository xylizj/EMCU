...
static inline tFrac32 Abs_F32_C(register tFrac32 f32In)
/*
...
static inline tFrac16 Abs_F16_C(register tFrac16 f16In)
/*
* @violates @ref MLIB_Abs_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
...
static inline tFloat Abs_FLT_C(register tFloat fltIn)
/*
* @violates @ref MLIB_Abs_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
...
static inline tFrac32 MLIB_Abs_F32(register tFrac32 f32In)
/*
* @violates @ref MLIB_Abs_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
...
static inline tFrac16 MLIB_Abs_F16(register tFrac16 f16In)
/*
* @violates @ref MLIB_Abs_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
...
@details      This inline function returns the absolute value of input parameter. The input value as well as output value
              is considered as single precision floating point data type. The output saturation is not implemented in
              this function, thus in case the absolute value of input parameter is outside the (-2\f$^{128}\f$, 2\f$^{128}\f$)
...
static inline tFloat MLIB_Abs_FLT(register tFloat fltIn)
/*
* @violates @ref MLIB_Abs_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header
* file.
*/
